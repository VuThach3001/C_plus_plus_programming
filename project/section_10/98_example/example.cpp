...
int main(void) {
  ...
  //   cout << "\nInitialization" <<
  //   "\n------------------------------------------" << endl; cout << "s1 is
  //   initialized to : " << s1 << endl; cout << " s2 is initialized to : " <<
  //   s2 << endl; cout << "s3 is initialized to: " << s3 << endl; cout << "s4
  //   is initialized to : " << s4 << endl; cout << " s5 is initialized to : "
  //   << s5 << endl; cout << "s6 is initialized to: " << s6 << endl; cout <<
  ...
  //   ; // True         Apple < Banana
  //   cout << s2 << " > " << s1 << ": " << (s2 > s1) << endl; // True Banana >
  //   Apple cout << s4 << " < " << s5 << ": " << (s4 < s5)
